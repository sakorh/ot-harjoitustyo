...
class Board:
    def __init__(self, empty_board, square_size, pieces, manager, gui_elements):
    ...
    def board_to_fen(self, turn, name):
        ...
        self.gui_elements.add_fen_to_options(name)
        return fen
    ...
    def begin_view(self, display):
        self.gui_elements.beginning_view()
        if self.load_fen:
            self.gui_elements.load_fen_view()
    ...
    def end_game(self, display):
        ...
        self.gui_elements.game_over_view()
        green = (0, 255, 0)
        black = (0, 0, 0)
        font = pygame.font.Font('freesansbold.ttf', 32)
