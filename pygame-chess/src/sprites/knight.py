...
class Knight(pygame.sprite.Sprite):
    def __init__(self, color, x=0, y=0):
            ...
            self.image_loaded = pygame.image.load(f"src/assets/knight_{color}.png")
    ...
    def show_options(self, x=0, y=0):
        options = [(x-80, y+160), (x+80,y+160), (x-160,y-80), (x-160,y+80),(x+160,y+80), (x+160,y-80),(x-80,y-160), (x+80,y-160)]
